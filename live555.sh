...
echo "COMPILE_OPTS=\$(INCLUDES) -I. -O3 -DSOCKLEN_T=socklen_t -D_LARGEFILE_SOURCE=1 -D_FILE_OFFSET_BITS=64 -DXLOCALE_NOT_USED=1 -DLOCALE_NOT_USED -fPIC -DNO_OPENSSL=1" >> $CONFIG_FILE
...
echo "CPLUSPLUS_FLAGS+=\$(CPPFLAGS) -fexceptions" >> $CONFIG_FILE
echo "OBJ=o" >> $CONFIG_FILE
echo "LINK=\$(CROSS_COMPILE)g++ -o" >> $CONFIG_FILE
echo "LINK_OPTS=-L. \$(LDFLAGS)" >> $CONFIG_FILE
